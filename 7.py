...
if __name__ == "__main__":
    ...
    # Aggiunta dello score per le tecniche con sottotecnica
    for base_id, count in count_by_base_id.items():
        ...
        # Se la tecnica principale non è presente in input, aggiungila con lo score corretto
        if not found:
            techniques_data.append({
                "techniqueID": base_id,
                "tactic": [],  # Aggiungi qui le tattiche se necessario
                "enabled": True,
